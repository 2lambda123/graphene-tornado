...
from graphene_tornado.ext.apollo_engine_reporting import EngineReportingAgent
from graphene_tornado.ext.apollo_engine_reporting import EngineReportingOptions
...
class ExampleEngineReportingApplication(tornado.web.Application):
    ...
    def __init__(self):
        engine_extension = lambda: EngineReportingExtension(
            engine_options, agent.add_trace
        )
        handlers = [
            (
                r"/graphql",
